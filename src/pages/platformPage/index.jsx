...
export default function PlatformPage() {
   ...
   const platformName = location.state?.platformName || platformSlug;
   ...
   useEffect(() => {
      if (platformId) {
         const url = `https://api.rawg.io/api/games?key=a573aa1a094c472284ead365bbd77d53&platforms=${platformId}`;
         updateUrl(url);
      }
   }, [platformId, updateUrl]);
