               ...
               {(data || !loading) && (
                  <div>
                     <div className="flex justify-between content-start pb-5">
                        <h1 className="text-3xl md:text-4xl text-accent font-semibold min-h-[2.5rem]">
                           {data?.name || 'n/a'}
                        </h1>
                        <ToggleFavorite data={data} className="text-[32px] md:text-3xl max-h-9 pt-1" />
                     </div>
                     <div className="flex justify-between min-h-[1.75rem]">
                     ...
                     <div className="style-game-image flex justify-center pt-8">
                        <figure className="w-full aspect-video bg-base-300">
                     ...
                     <p className="min-h-[4rem]">{data?.description_raw || 'n/a'}</p>
                  </div>
               )}
            </div>
         </main>
